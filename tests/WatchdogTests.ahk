...
TestWatchdogRecovery() {
	...
	AssertEqual(WatchdogFixtureEvents(events), "main,players,release", "Ready macro survives handle release after ordered cleanup")
	Loop 2
	...
	AssertEqual(WatchdogFixtureEvents(events), "main,players,close,release,main,players,close,release,main,players,close,release", "Every failed replacement is stopped before the next launch")
	...
	AssertEqual(WatchdogFixtureEvents(events), "main,players,close", "Failed cleanup retains its process handle")
